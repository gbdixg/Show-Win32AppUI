...
.SYNOPSIS
    ...
    Created from EXE wrapper template
.NOTES
	Latest update %Date%
#>
[cmdletbinding()]
...
PROCESS{
    ...
    Write-TxtLog "Uninstaller = '$SetupFile'"
    ...
    Switch ($Retcode){
        ...
        3010 {
            Write-TxtLog  "3010 = Removed successfully. Restart required" -indent 1
        ...
        1641 {
            Write-TxtLog  "1641 = Package correctly removed. Uninstaller initiated a restart" -Indent 1
        ...
        default {
            Write-TxtLog  "Failed based on return code '$Retcode'"
        }
	}
